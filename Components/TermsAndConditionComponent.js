...
export default class TermsAndConditionComponent extends Component {
    ...
    //         headerLeft: () => <Button 
    //         title="Agree" backgroundColor="rgba(0,0,0,0)" color="rgba(0,122,255,1)"
...
constructor() {
    ...
    render () {
        ...
        <SafeAreaView>
        <ScrollView>
        <Text style = {{fontSize: 30, fontWeight: '500', alignSelf: 'center'}}>Terms & Conditions</Text>
            <Text>
...
These Terms will be governed by and interpreted in accordance with the laws of the State of Country, and you submit to the non-exclusive jurisdiction of the state and federal courts located in Country for the resolution of any disputes.
        ...
        <Button title = 'Agreed' onPress={() => this.props.navigation.navigate('Login')}></Button>
        </ScrollView>
        </SafeAreaView>
    </View>
    }
